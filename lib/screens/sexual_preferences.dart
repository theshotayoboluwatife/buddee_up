            ...
            SafeArea(
              child: Row(
                  ...
                  children: [
                    ...
                    CustomText(text: "Sexual Preferences", fontSize: 40, fontWeight: FontWeight.w600,)
                  ]),
            ),
            SizedBox(height: 40,),
            CustomText(text: "Select your sexual preference", fontSize: 20, fontWeight: FontWeight.w400,),
            SizedBox(height: 10,),
            Container(),
            Spacer(),
