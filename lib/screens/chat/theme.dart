...
class LightTheme extends AppTheme {
  LightTheme({
    ...
    TextStyle linkPreviewIncomingTitleStyle = const TextStyle(),
    TextStyle linkPreviewOutgoingTitleStyle = const TextStyle(),
    Color replyTitleColor = const Color(0xffFCD8DC),
    ...
    Color outgoingChatBubbleColor = const Color.fromARGB(249, 144, 144, 144),
    Color inComingChatBubbleColor = const Color.fromARGB(34, 195, 32, 210),
    Color inComingChatBubbleTextColor = Colors.black,
    Color repliedMessageColor = const Color(0XFF666666),
    Color closeIconColor = Colors.black,
    Color shareIconBackgroundColor = const Color(0xFFE0E0E0),
    Color sendButtonColor = const Color(0XFF666666),
    ...
    Color verticalBarColor = const Color(0XFF666666),
